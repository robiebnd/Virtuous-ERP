...
public final class StockCountLineMapper {
    ...
    public static StockCountLineResponse toResponse(StockCountLine entity) {
        ...
        if (variance == null
                && entity.getCountedQuantity() != null
                && entity.getSystemQuantity() != null) {

            variance = entity.getCountedQuantity()
                    .subtract(entity.getSystemQuantity());
        }
        ...
        return StockCountLineResponse.builder()
                ...
                .stockCountId(
                        entity.getStockCount() != null
                                ? entity.getStockCount().getId()
                                : null)
