...
public interface FxRateRepository extends JpaRepository<FxRate,UUID> {
    ...
    Optional<FxRate> findTopByRateDateLessThanEqualAndFromCurrencyAndToCurrencyOrderByRateDateDesc(java.time.LocalDate rateDate,String fromCurrency,String toCurrency);
}