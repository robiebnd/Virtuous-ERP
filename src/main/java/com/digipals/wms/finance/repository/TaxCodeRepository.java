...
public interface TaxCodeRepository extends JpaRepository<TaxCode,UUID> {
    ...
    Optional<TaxCode> findByCompanyCodeAndTaxCodeIgnoreCase(String companyCode,String taxCode);
    List<TaxCode> findByCompanyCodeOrderByTaxCode(String companyCode);
}