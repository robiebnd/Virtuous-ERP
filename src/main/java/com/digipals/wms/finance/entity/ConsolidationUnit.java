...
public class ConsolidationUnit extends BaseEntity { @Column(name="unit_code",nullable=false,unique=true) String unitCode; @Column(name="company_code",nullable=false,length=20) String companyCode; String unitName; String localCurrency; java.math.BigDecimal ownershipPercent; }