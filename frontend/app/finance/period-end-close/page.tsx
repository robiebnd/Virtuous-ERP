 ...
 const load=async()=>{
  ...
  try{
   ...
   setChecks([
    ...
    {id:"carryforward",name:"Balance carryforward",description:"Verify year-end balance carryforward before opening the new fiscal year.",status:"NOT_AUTOMATED",detail:"Fiscal-year carryforward requires fiscal-period architecture and is intentionally not simulated."},
